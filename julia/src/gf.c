...
//>>> Instrumentation
#include "uthash.h"
int _toggle_a = 0; // used for generic calls
int _toggle_b = 0; // used for method invocations
...
JL_DLLEXPORT void jl_start_instrumentation(void) {
    _toggle_a = 1;
    _toggle_b = 1;
}

JL_DLLEXPORT void jl_stop_instrumentation(void) {
    _toggle_a = 0;
    _toggle_b = 0;
}

JL_DLLEXPORT void jl_end_instrumentation(void) {
    _toggle_a = 0;
    _toggle_b = 0;
